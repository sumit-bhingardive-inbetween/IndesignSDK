...
// Plug-in:
#define kMP1PluginName	"MyPlugin1"			// Name of this plug-in.
...
#define kMP1Author		"Sumit Bhingardive"					// Author of this plug-in (for the About Box).
...
//DECLARE_PMID(kInterfaceIDSpace, IID_IMYINTERCEPTER, kMP1Prefix + 1)
...
// ImplementationIDs:
//DECLARE_PMID(kImplementationIDSpace, kMP1Impl, kMP1Prefix + 0)
...
//DECLARE_PMID(kImplementationIDSpace, kMyIntercepterImpl, kMP1Prefix + 23)
DECLARE_PMID(kImplementationIDSpace, kMyCSXSPluginImpl, kMP1Prefix + 24)
DECLARE_PMID(kImplementationIDSpace, kMyObserverImpl, kMP1Prefix + 25)
